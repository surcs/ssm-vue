...
<script>
  export default {
      created() {
        var v = this;
        this.$http.post('/dispatchOrder/selectWarehouseKeeperUncheck')
    ...
    methods: {
      handleConfirm(index, row) {
        ...
        this.$confirm('是否确认', '警告', {
          ...
          .then(() => {
            this.$http.post('/dispatchOrder/updateDispatchOrderWarehouseKeeper',
                        {
                            id: row.id,
                            goodsId: row.goodsId,
                            ...
                            sum: row.sum,
                            number: row.number,
                            salesKeeperId:row.salesKeeperId,
                            warehouseKeeperId:'',
