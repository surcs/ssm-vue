  ...
  <el-table
    ...
    <el-table-column
        ...
        <template slot-scope="{row}">
            <el-input v-model="row.logisticsId"></el-input>
        </template>
    </el-table-column>
    <el-table-column
      align="right">
...
<script>
  export default {
      created() {
        var v = this;
        this.$http.post('/purchaseOrder/selectToClose')
    ...
    methods: {
      handleConfirm(index, row) {
        ...
        this.$confirm('是否确认', '警告', {
          ...
          .then(() => {
            this.$http.post('/purchaseOrder/updateToClose',
                        {
                            id: row.id,
                            goodsId: row.goodsId,
                            state: row.state,
                            ...
                            address: row.address,
                            number: row.number,
                            warehouseKeeperIdConfirm: row.warehouseKeeperIdConfirm,
                            warehouseKeeperIdClose:'',
